...
const OurStoryLong = () => (
  <div id='ourstorylong-container' className='page-container'>
    <h1>Our Story</h1>
    ...
    <p className='his'>In June, I had the pleasure of attending a wedding of yet
      another friend from what has described as my “college debate club” (despite
      it being mine, I’ve no better description to offer in this space).  This was
    ...
    <p className='his'>The wedding was outdoors, in Northern Virginia.  I was no
      ...
      Not that any words got out of my mouth before I heard “So, Bill.....are you
      still looking for a wife.”  Obviously, though taken aback, I managed to respond
    ...
    <p className='his'>I should note that I was seated at a table with the first
      ...
      cutting him off to let him know he’d been beaten to the punch.  We began
      discussing possible options and timing for first contact—not the sort of decision
    ...
    <p className='his'>(She says “escalated” to texting&mdash;but really it was
    ...
    <p className='his'>Please allow me to interject here.  Let’s go through that
      ...
      Governor’s Island.  Where we walked around for a couple hours.  Distillery
    ...
    <p className='his'>This was apparently the “less walking” version of whatever
    ...
    <p className='hers'>At some point between the "deciding to move to Pittsburgh"
      ...
      this to him 😂. He pretended to be overwhelmed, as he stereotypically should
    ...
    <p className='his'>This is an understatement.  As we’d moved from discussing
      possible wedding plans to booking actual ones, I had become increasingly
      aware of every set of eyes&mdash;real or imagined&mdash;searching Claire’s
      ...
      formally “engaged.”  So, the prior evening having already been spoken for,
    ...
    <p className='his'>You know, I wasn’t supposed to have to declare my love again...
