...
const Baseball = () => (
  <div id='baseball-container' className='page-container'>
    ...
    <h5><em>These tickets will be fully refundable if there is no game at PNC Park
      that day (and if the MLB is open, we should be clear to celebrate)!<br />
