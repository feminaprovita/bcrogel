...
const OurStory = () => (
  <div id='ourstory-container' className='page-container'>
    ...
    <p className='hers'>It became pretty quickly apparent that Bill couldn't leave
      ...
      Pittsburgh!</p>
    <p className='his'>(I imagine these parts here include some mockery for the walking...)</p>
    {/* <p className='his'>...</p> */}
    ...
    <p className='his'>(Something about meeting the whole family here, perhaps?)</p>
    ...
    <p className='his'>(The plan/setup? Everything up to when I actually woke up?)</p>
