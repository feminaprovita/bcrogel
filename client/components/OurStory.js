...
const OurStory = () => (
  <div id='ourstory-container' className='page-container'>
    ...
    <h3>Her Story</h3>
    <p>So I have this one atheist friend who likes to talk theology. Just enjoys
    ...
    <p>Anyway, so my atheist friend texts me one day, "We need to talk about
    ...
    <p>At the reunion weekend of his college debate club the preceding weekend,
    ...
    <p>I encouraged him to act on this intuition! But, because this dear,
      ...
      say anything!</p>
    <p>During this time, I sent out an email to a couple dozen friends, asking
