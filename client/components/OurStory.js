...
const OurStory = () => (
  <div id='ourstory-container' className='page-container'>
    <h1>Our Story</h1>
    <div className='story-holder' id='setup-container'>
      <img
        className='small-image story-img'
        id='story-subway'
      ...
      <div id='setup-story'>
        <h2>THE SETUP</h2>
        <p>So the key here is what we'll call Bill's college debate
        ...
        <p>A brain like Claire's tries to catalog such people, to
        ...
        <p>He thought this was a safe thing to say, as she'd had a
        ...
        <p>On that day, seven months later, Bill was attending the
        ...
        <p>Two hours later, the first friend cautiously broached
    ...
    <div className='story-holder' id='proposal-container'>
      <div id='proposal-story'>
        <h2 className='proposal'>THE PROPOSAL</h2>
        <p>Ring arrived Monday. Tuesday they left to visit Claire's
        ...
        <p>But Claire had been stuck working very late the previous
        ...
        <p>Claire awoke to find a note next to her pillow, with
        ...
        <p>So, there was a scavenger hunt! A dozen roses hidden
      ...
      <img
        className='small-image story-img'
        id='story-ring'
        src='./images/ring_with_flowers.jpg'
        alt='Ring with roses'
        />
    </div>

    <p className='comment'><em>For any of you gluttons for punishment, our overly
      detailed first draft is hidden <Link to='/ourstorylong'>here</Link>, for your
      reading pleasure...</em></p>
  </div>
)
